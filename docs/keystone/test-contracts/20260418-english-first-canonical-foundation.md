...
- **When**: checking [README.md](/Users/allen/Workspace/projects/personal/Keystone/README.md)
...
- **Given**: Codex users need to install and start Keystone from repo docs
- **When**: checking [docs/README.codex.md](/Users/allen/Workspace/projects/personal/Keystone/docs/README.codex.md)
...
- **When**: checking [docs/quickstart.md](/Users/allen/Workspace/projects/personal/Keystone/docs/quickstart.md)
...
- **When**: checking `ks-help`, `ks-orchestrate`, `ks-writing-plan`, `ks-verify`, and `ks-review`
