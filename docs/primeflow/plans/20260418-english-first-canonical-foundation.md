...
## Direction Source
This plan came from the `pf-roundtable` conclusion that PrimeFlow should not stop at translating the homepage. The target was to move every default public-facing and runtime-facing surface toward English, with Chinese no longer acting as the canonical source for core product behavior.

## Current Block
Establish the English-first canonical foundation so new international users can understand PrimeFlow, install it, and enter the core workflow through the default entry surfaces, while the first critical runtime skills no longer default to Chinese.
...
- [README.md](/Users/allen/Workspace/projects/personal/PrimeFlow/README.md), [docs/README.codex.md](/Users/allen/Workspace/projects/personal/PrimeFlow/docs/README.codex.md), and at least one install/quickstart doc are English-first
- the canonical `SKILL.md` files for `pf-help`, `pf-orchestrate`, `pf-writing-plan`, `pf-verify`, and `pf-review` are English while keeping decision labels, state keys, and telemetry semantics stable
...
## Entry Conditions
- PrimeFlow's default public language is intentionally switching to English
...
## Dependencies
- historical draft: [readme-rewrite-draft.md](/Users/allen/Workspace/projects/personal/PrimeFlow/archive/zh-CN/claude-optimization/readme-rewrite-draft.md)
- historical template: [skill-english-template.md](/Users/allen/Workspace/projects/personal/PrimeFlow/archive/zh-CN/claude-optimization/skill-english-template.md)
- install and smoke entry points: [package.json](/Users/allen/Workspace/projects/personal/PrimeFlow/package.json), [primeflow](/Users/allen/Workspace/projects/personal/PrimeFlow/primeflow)
