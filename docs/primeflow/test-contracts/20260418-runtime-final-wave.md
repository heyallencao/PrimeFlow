...
- **When**: checking `.agents/skills/pf-bug-triage/SKILL.md`
...
- **When**: checking `.agents/skills/pf-docs-writer/SKILL.md`
...
- **When**: checking `.agents/skills/pf-knowledge/SKILL.md`
...
- **When**: checking `.agents/skills/pf-pr-prep/SKILL.md`
...
- **When**: checking `.agents/skills/pf-qa/SKILL.md`
...
- **When**: checking `.agents/skills/pf-ship/SKILL.md`
