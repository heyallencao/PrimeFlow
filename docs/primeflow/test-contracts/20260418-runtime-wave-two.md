...
- **When**: checking `.agents/skills/pf-test-first/SKILL.md`
...
- **When**: checking `.agents/skills/pf-implement/SKILL.md`
...
- **When**: checking `.agents/skills/pf-diagnose/SKILL.md`
...
- **When**: checking `.agents/skills/pf-brief/SKILL.md`
