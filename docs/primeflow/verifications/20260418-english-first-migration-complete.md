...
### Claims
- PrimeFlow is now English-first across active public docs, active maintainer docs, contribution docs, GitHub templates, examples, install/onboarding surfaces, and canonical skills.
